...
import (
	mysqlv1alpha1 "atom-mysql-operator/pkg/apis/mysql/v1alpha1"
	versioned "atom-mysql-operator/pkg/generated/clientset/versioned"
	internalinterfaces "atom-mysql-operator/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "atom-mysql-operator/pkg/generated/listers/mysql/v1alpha1"
	time "time"
...
func (f *backupScheduleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mysqlv1alpha1.BackupSchedule{}, f.defaultInformer)
}
